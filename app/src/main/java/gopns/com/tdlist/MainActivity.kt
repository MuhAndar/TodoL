...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        todoViewModel = ViewModelProvider(this).get(TodoLVM::class.java)
    ...
    private fun showEditDialog(todo: TodoL) {
        val view = LayoutInflater.from(this).inflate(R.layout.fragment_todolist, null)
    ...
    private fun showDeleteDialog(todo: TodoL) {
        todoViewModel.deleteTodo(todo)
        Toast.makeText(this, "Data Telah Dihapus", Toast.LENGTH_SHORT).show()
    }

    private fun showDetailsDialog(todo: TodoL) {
